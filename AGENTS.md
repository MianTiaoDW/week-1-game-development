...
1. 每次开始工作先读 `HANDOFF_2026-08-25_BRAND_AND_LOADING_LOOP.md`，再读 `docs/HANDOFF_2026-08-26_BANANA_BEETLE_REFINEMENT.md`；后者是第一镜 Banana 精修与当前任务的最高优先级事实源。
...
8. 当前唯一优先任务是完成星荚甲虫最后一次局部微修：物种外形已通过，但必须修为主要背对镜头、严格两根嫩芽触角、六条腿、窄折叠翅膜。通过后立即锁定甲虫并制作米露卡平视探头终帧。禁止全图 Banana 精修；波姆美宣继续暂停。
